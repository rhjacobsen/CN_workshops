...
| Node      |	Eth0 	            | Eth1                | Eth2
|-----------|-------------------|-------------------------|-------
| Node 1	  | 192.168.1.2 / 24  | N/A               |  N/A
| Node 2	  | 192.168.2.2 / 24  | N/A               |  N/A
| Node 3	  | 192.168.3.2 / 24  | N/A               |  N/A
| Router 1	| 192.168.0.1 / 30  | 192.168.0.10 / 30   | 192.168.1.1 / 24
| Router 2	| 192.168.0.5 / 30  | 192.168.0.2 / 30    | 192.168.2.1 / 24
| Router 3	| 192.168.0.9 / 30  | 192.168.0.6 / 30    | 192.168.3.1 / 24
...
> ##### Challenge 4.9
> Briefly explain what happens, both when the route is being removed and when it is being established again. Hint: Examine the forwarding tables on relevant nodes and use traceroute to verify routes in the network. Use forwarding tables to document your observations.
> ```
>
>
>
...
> ##### Challenge 4.10
> With the link between Router-1 and Router-2 disabled, run ```traceroute``` again on "Node 1" to find the route. Write it down and briefly explain if it is as expected.
> ```
>
>
>
...
> ##### Challenge 4.12
> Verify and discuss the metrics determined by RIP for Router 1.
> ```
>
>
>
