...
There is a good about of [documentation for GNS3]([https://docs.gns3.com/). It is recommended to install a GNS3 virtual machine (VM) in addtion to the desktop installation for better scaleabiity and robustness.
